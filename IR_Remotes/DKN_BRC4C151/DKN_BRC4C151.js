...
class IREncoder {
    ...
    static getEncodedByteArray(irInfo) {
        ...
        while (j < noOfSignal) {
            ...
            //12
            irData[i] = swingOptions["vertical"][swing_v] | (modeOptions[mode]["fan"] ? modeOptions[mode]["fan"] : fanOptions[fan]);
            checkSum += IRUtils.binaryReverse({ number: irData[i], pow: 8 });
            i++;
    ...
    static getConfigInfo() {
        return {
            configData: [29300, 5080, 2055, 365, 655, 365, 1750, 365, 33000],
